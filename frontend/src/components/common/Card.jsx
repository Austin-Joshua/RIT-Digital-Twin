    ...
    return (
        <motion.div
            ...
            style={{
                ...
                transition: 'background-color var(--transition-speed) var(--transition-ease), border-color 0.2s var(--transition-ease), box-shadow 0.2s var(--transition-ease), transform 0.2s var(--transition-ease)',
