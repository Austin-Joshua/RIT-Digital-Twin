...
export const academicAiApi = {
    ...
    getClassTimetableGenerateAccess: (semesterNumber) => api.get('/academic/timetable/generate-access', { params: { semesterNumber } }),
    getClassTimetableSections: (semesterNumber) => api.get('/academic/timetable/sections', { params: { semesterNumber } }),
    exportClassTimetablePdf: (payload) => api.post('/academic/timetable/export-pdf', payload, { responseType: 'blob' }),
